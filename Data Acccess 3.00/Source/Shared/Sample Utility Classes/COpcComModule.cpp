//==============================================================================
// TITLE: COpcComModule.cpp
//
// CONTENTS:
// 
// A class that handles initialization and registration of a COM module.
//
...
// 2003/09/29 RSA   Removed a rundant call to Run() when running as a WIN32 service.
...
// 899A3075-F94E-4695-9DF8-0ED25B02BDBA
static const GUID CATID_OPCUAServer10 = {0x899A3075, 0xF94E, 0x4695, { 0x9D, 0xF8, 0x0E, 0xD2, 0x5B, 0x02, 0xBD, 0xBA } }; 
...
)
{
	...
	HRESULT hResult = OpcEnumServersInCategory(NULL, CATID_OPCUAServer10, &cClsids);
