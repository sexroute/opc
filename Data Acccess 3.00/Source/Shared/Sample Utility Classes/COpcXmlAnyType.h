//==============================================================================
// TITLE: COpcXmlAnyType.h
//
// CONTENTS:
// 
// A class that contains an arbitrary value (simple or complex).
//
...
template<> 
inline UINT CustomHashKey<OpcXml::QName>(const OpcXml::QName& cName)
{
