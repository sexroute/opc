...
namespace Dse
{
    public class FixDef
    {
        ...
        public static int FIELD_CODE = 1001;//返回码

        public static int FIELD_MESSAGE = 1002;//返回说明//
                                               //
                                               ////*********************功能码****************************//
        public static int FUNC_MODULE_TESTFUNC = 10001;
        ////************************实时数据读取部分******************************//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETALLFIVECHAR = 20000;//读取指定机组所有振动测点的五种特征值//
                                                                    ///**读取指定任意多个测点的各种类型的特征值。
        //*输入参数：
        //*          公司ID   FIELD_SYSTEM_COMPANY
        //*			 分厂名   FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETSPECFIVECHAR = 20001;//读取指定机组指定振动测点的五种特征值。//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETALLTYPECHAR = 20002;//得到往复式机械设备运行状态实时趋势//
        ...
        //*          时间                             FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETSPECTRUM = 20003;//
        ...
        //*          单位             FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_ON_GETFOURSPECCHAR = 20004;//
        ...
        //*          单位             FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_ON_GETALLPROCVALUE = 20005;//
                                                                     ///**得到指定多个过程量测点的值。
        //*输入参数：
        //*          公司ID           FIELD_SYSTEM_COMPANY
        //*			     分厂名           FIELD_SYSTEM_FACTORY
        ...
        //*          单位             FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_ON_GETSPECPROCVALUE = 20006;//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETWAVE = 20007;//
                                                             ///**得到某一组轴心轨迹的波形数据。
        //*输入参数：
        //*          公司ID   FIELD_SYSTEM_COMPANY
        //*			 分厂名   FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETAXESTRACK = 20008;//
                                                                  ///**得到指定机组指定一组测点轴心位置值。
        //*输入参数：
        //*          公司ID               FIELD_SYSTEM_COMPANY
        //*			     分厂名               FIELD_SYSTEM_FACTORY
        ...
        //*            时间           FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETAXESLOCATION = 20009;//
        ...
        //*            时间           FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETREV = 20010;//
                                                            ///**得到指定机组任意多个轴位移测点值
        //*输入参数值：
        //*            公司ID   FIELD_SYSTEM_COMPANY
        //*			   分厂名   FIELD_SYSTEM_FACTORY
        ...
        //*            时间           FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETSPECAXISDISPLACE = 20011;//
        ...
        //*            时间           FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETALLAXISDISPLACE = 20012;//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETALLCHANNELSTATE = 20013;//
        ...
        //*            时间           FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETALLCHANNVALUE = 20014;//
                                                                      //
        ...
        //*          排气阀关闭相位角                      FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_ON_GETPVDATA = 20015;//
        ...
        //*          自定义参数数据BUFFSIZE                FIELD_SERVICE_CHANN_BUFFSIZE
        //*/
        public static int SERVICE_SERVICE_ON_GETRODSINKDATA = 20016;//
        ...
        //*            指定机组的转速2      FIELD_SERVICE_OFF_REV2
        //*/
        public static int SERVICE_SERVICE_ON_GETSUBCORPSTATE = 20017;//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETBODE = 20018;//
                                                             //
        ...
        //*          启停车事件ID     FIELD_SYSTEM_EVENT_ID
        //*/
        public static int SERVICE_SERVICE_ON_GETWATERFALL = 20019;//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETZOOMSPEC = 20020;//
                                                                 ///**得到指定指定机组和测点的相关信息
        //*输入参数：
        //*          公司ID           FIELD_SYSTEM_COMPANY
        //*			  分厂名           FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETSPECCHANNINFO = 20021;//
        ...
        //*            转速：      FIELD_SERVICE_REV
        //*/
        public static int SERVICE_SERVICE_ON_GETALLSPECCHARANDPHASE = 20022;//
        ...
        //*          排气阀关闭相位角           FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_ON_GETRCMULTIPARAMDATA = 20023;//
                                                                         ///**集团级实时报警统计
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GROUPALARMSTAT = 20024;//
                                                                    ///**读取公司级实时报警统计
        //*输入参数值：公司ID          FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_COMPANYALARMSTAT = 20025;//
                                                                      ///**读取监测站级实时报警统计
        //*输入参数值：公司ID          FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        //*	         设备名           FIELD_SERVICE_PLANTID
        ...
        //*		     报警ID           FIELD_SERVICE_ALARMID
        //*/
        public static int SERVICE_SERVICE_ON_MONITORALARMSTAT = 20026;//
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETRODSINKAXESLOCATION = 20027;//
        ...
        //*		       时间				   	   			 FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_ON_GETDYNSTRESSWAVE = 20028;//
                                                                      //
                                                                      ///**得到某一组提纯轴心轨迹的波形数据。
        //*输入参数：
        //*          公司ID               FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GETPURIFYAXESTRACK = 20029;//
        ...
        //*          排气阀关闭相位角                      FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_ON_GETCEPSTRUM = 20030;//
        ...
        //*          转子旋向：                       FIELD_SYSTEM_TYPE //0:为逆时针,1为顺时针
        //*/
        public static int SERVICE_SERVICE_ON_GETFULLSPECSTRUM = 20031;//
                                                                      ///** 获取异常数据检测结果
        //*输入参数字段码：无
        //*返回值的字段码：(n)
        //*            公司ID                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SERVICE_ON_GET_ABNORMAL_DATA_RECORD = 20032;//
                                                                              //
                                                                              ///***************************历史读取数据部分*************************/
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETCURTREND = 21001;//
        ...
        //*          自定义参数数据BUFF                    FIELD_SERVICE_LEARNPARAM_BUFF
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECFREQWAVE = 21002;//
        ...
        //*          测点单位             FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETTREND = 21003;//
                                                               //
        ...
        //*          时间             FIELD_SERVICE_OFF_TIME
        //*/
        public static int SERVICE_SERVICE_OFF_GETAVIBCHANNTREND = 21004;//
        ...
        //*          时间值                FIELD_SERVICE_OFF_TIME
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXISLOCATIONTREND = 21005;//
                                                                           //
        ...
        //*          单位            FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETTWOCHANNDETAILINFO = 21006;//
        ...
        //*          状态描述         FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SERVICE_OFF_GETZOOMSPEC = 21007;//
                                                                  //
        ...
        //*          进动方向：                       FIELD_SYSTEM_STATUS//1:为反进动,2为正进动
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXESTRACK = 21008;//
        ...
        //*          单位            FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECPLANTCHANNSDETAILINFO = 21009;//
                                                                                   ///*!得到指定测点、时间的基本报警信息
        //*输入参数字段码
        //*          公司ID          FIELD_SYSTEM_COMPANY
        //*			     分厂名          FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECVIBCHANNALARMINFO = 21010;//
        ...
        //*/
        public static int SERVICE_OFF_GETVIBCHANNALARMLOG = 21011;//
        ...
        //*          自定义参数数据BUFF：  FIELD_SERVICE_LEARNPARAM_BUFF
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECALARMTIMERECORD = 21012;//
                                                                             //
                                                                             ///*!得到指定时间范围的指定机组的启停车记录
        //*输入参数字段码
        //*          公司ID   FIELD_SYSTEM_COMPANY
        ...
        //*          终止时间：    FIELD_SERVICE_OFF_TIMEEND
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECTIMERANGESUD = 21013;//
        ...
        //*          振动特征值结构体    FIELD_SERVICE_CHARVALUE_S
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECTIMECHANNSUD = 21014;//
        ...
        //*          振动特征值结构体    FIELD_SERVICE_CHARVALUE_S
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNREVSUD = 21015;//
        ...
        //*          振动特征值结构体    FIELD_SERVICE_CHARVALUE_S
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNSAVETIMESUD = 21016;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETVIBCHANNSTREND = 21017;//
        ...
        //*          转速Buff             FIELD_SERVICE_REV_BUFF
        //*/
        public static int SERVICE_SERVICE_OFF_GETCURRVIBCHANNSTREND = 21018;//
        ...
        //*          转速            FIELD_SERVICE_OFF_REV
        //*/
        public static int SERVICE_SERVICE_OFF_GETTWOCHANNDATA = 21019;//
        ...
        //*          单位            FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECPLANTPROCCHANNSDETAILINFO = 21020;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECEVENTCHANNSSUDTREND = 21021;//
        ...
        //*          单位                 FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECEVENTTIMECHANNSSUDDETAILINFO = 21022;//
        ...
        //*          单位            FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECPLANTCHANNSINFO = 21023;//
                                                                             ///**得到指定公司、分厂、设备的任意多个振动测点的报警限等信息（依次循环测点的数据）
        //*输入参数：
        //*          公司ID          FIELD_SYSTEM_COMPANY
        //*			     分厂名          FIELD_SYSTEM_FACTORY
        ...
        //*          对应时间的微秒      FIELD_SERVICE_MICROSECOND
        //*/
        public static int SERVICE_SERVICE_OFF_GETVIBCHANNALARMTREND = 21024;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXESLOCATIONALARMTREND = 21025;//
        ...
        //*          终止时间：    FIELD_SERVICE_OFF_TIMEEND
        //*/
        public static int SERVICE_SERVICE_OFF_GETALARMDATATIMERANGE = 21026;//
                                                                            ///**得到指定报警事件的报警数据保存的开始截止时间
        //*          公司ID   FIELD_SYSTEM_COMPANY
        //*			     分厂名   FIELD_SYSTEM_FACTORY
        //*          机组ID               FIELD_SERVICE_PLANTID
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXESLOCATIONALARMDATA = 21027;//
        ...
        //*          报警点标示          FIELD_SYSTEM_STATUS
        //*/
        public static int SERVICE_SERVICE_OFF_GETVIBALARMINFOTREND = 21028;//
        ...
        //*          报警点标示          FIELD_SYSTEM_STATUS
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXISDISPLACEALARMTREND = 21029;//
        ...
        //*          报警点标示          FIELD_SYSTEM_STATUS
        //*/
        public static int SERVICE_SERVICE_OFF_GETPROCALARMTREND = 21030;//
        ...
        //*          测点值              FIELD_SERVICE_TREND_PROCESS
        //*/
        public static int SERVICE_SERVICE_OFF_GETPROCALARMDATA = 21031;//
        ...
        //*          转速:               FIELD_SERVICE_OFF_REV
        //*/
        public static int SERVICE_SERVICE_OFF_GETTRENDALARMDATA = 21032;//
        ...
        //*          报警类型            FIELD_SYSTEM_TYPE
        //*/
        public static int SERVICE_SERVICE_OFF_GETAXISDISPLACEALARMDATA = 21033;//
        ...
        //*          危险值          FIELD_SYSTEM_ALARM_HIGH
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECALARMTIMERECORDCHARVALUE = 21034;//
                                                                                      //
                                                                                      ///**得到指定历史时刻、机组示功图测点的波形。
        //*输入参数值：公司ID             FIELD_SYSTEM_COMPANY
        //*		     分厂名            FIELD_SYSTEM_FACTORY
        ...
        //*            排气阀关闭相位角                      FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_OFF_GETPVDATA = 21035;//
        ...
        //*          自定义参数数据BUFF                    FIELD_SERVICE_LEARNPARAM_BUFF
        //*/
        public static int SERVICE_SERVICE_OFF_GETRODSINKDATA = 21036;//
        ...
        //*            排气阀关闭相位角             FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_OFF_GETRCMULTIPARAMDATA = 21037;//
        ...
        //*            转速5          FIELD_SERVICE_REV5
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECTIMEALLCHANNVALUE = 21038;//
        ...
        //*          垂直方向特征值结构体           FIELD_SERVICE_CHARVALUE_S2
        //*/
        public static int SERVICE_SERVICE_OFF_GETSUDPURIFYAXESTRACK = 21039;//
        ...
        //*			 			 时间				   			 FIELD_SERVICE_TIME
        //*/
        public static int SERVICE_SERVICE_OFF_GETALARMDYNSTRESSWAVE = 21040;//
        ...
        //*            横坐标                     FIELD_SERVICE_FREQWAVE2
        //*/
        public static int SERVICE_SERVICE_OFF_GETALARMRCMULTIPARAMDATA = 21041;//
        ...
        //*          测点ID              FIELD_SERVICE_CHANN1
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECPLANTMONTHREPORT = 21051;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECTIMERANGEFACTORYRUNINFO = 21052;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_CORRDIGN = 21053;//
                                                               ///**集团级历史报警统计
        //*输入参数值：公司ID          FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        //*            起始时间：       FIELD_SERVICE_OFF_TIMESTART
        ...
        //*		     报警设备数       FIELD_SERVICE_ALARM_PLANTNUM
        //*/
        public static int SERVICE_SERVICE_OFF_GROUPALARMSTAT = 21054;//
                                                                     ///**公司级历史报警统计
        //*输入参数值：公司ID          FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        //*            起始时间：       FIELD_SERVICE_OFF_TIMESTART
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_COMPANYALARMSTAT = 21055;//
                                                                       ///**监测站级历史报警统计
        //*输入参数值：公司ID          FIELD_SYSTEM_COMPANY
        //*		        分厂名           FIELD_SYSTEM_FACTORY
        //*	            设备名           FIELD_SERVICE_PLANTID
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_MONITORALARMSTAT = 21056;//
        ...
        //*        对应时间的微秒   FIELD_SERVICE_MICROSECOND
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNALARMMULTCHARVALUES = 21057;//
        ...
        //*            对应时间的微秒       FIELD_SERVICE_MICROSECOND
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNSALARMSINGLECHARVALUE = 21058;//
        ...
        //*		  报警椭圆垂直轴半径  FIELD_SERVICE_VER_RADIUS
        //*/
        public static int SERVICE_SERVICE_OFF_GETRODSINKAXESLOCATION = 21059;//
                                                                             ///**得到往复式机械设备运行状态历史趋势
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETHISRUNSTATUS = 21060;//
        ...
        //*            时间值           FIELD_SERVICE_OFF_TIME
        //*/
        public static int SERVICE_SERVICE_OFF_GETHISCOMPARE = 21061;//
        ...
        //*            转速             FIELD_SERVICE_REV
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHARVALUEWAVE = 21062;//
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNSCHARVALUE = 21063;//
                                                                             ///**得到往复式机械设备机组月报表；
        //*输入参数值：公司ID           FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        //*            机组ID           FIELD_SERVICE_PLANTID
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECRECIPMONTHREPORT = 21064;//
        ...
        //*		     转速1            FIELD_SERVICE_REV
        //*/
        public static int SERVICE_SERVICE_OFF_MONITORALARMSTATCHAR = 21065;//
        ...
        //*          进动方向：                     FIELD_SYSTEM_STATUS//1:为反进动,2为正进动
        //*/
        public static int SERVICE_SERVICE_OFF_GETPURIFYAXESTRACK = 21066;//
        ...
        //*          排气阀关闭相位角     FIELD_SERVICE_ANGLEPARAM4
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECCHANNCEPSTRUM = 21067;//
                                                                           //
                                                                           //
        ...
        //*            对应时间的微秒          FIELD_SERVICE_MICROSECOND
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECALARMIDCHARVALUES = 21068;//
                                                                               //
        ...
        //*          自定义参数数据BUFF   FIELD_SERVICE_LEARNPARAM_BUFF
        //*/
        public static int SERVICE_SERVICE_OFF_GETSPECALARMTIMEDYNRECORD = 21069;//
        ...
        //*          转子旋向：                       FIELD_SYSTEM_TYPE //0:为逆时针,1为顺时针
        //*/
        public static int SERVICE_SERVICE_OFF_GETFULLSPECSTRUM = 21070;//
                                                                       ///**报警查询功能，查询报警ID报警类型
        //*输入参数值：公司ID           FIELD_SYSTEM_COMPANY
        //*		     分厂名           FIELD_SYSTEM_FACTORY
        //*	         设备名           FIELD_SERVICE_PLANTID
        ...
        //*            成功标示          FIELD_SYSTEM_STATUS
        //*/
        public static int SERVICE_SERVICE_OFF_GETALARMLOGINFO = 21071;//
        ...
        //*		       测点2角度参数4		       FIELD_SERVICE_ANGLEPARAM8
        //*/
        public static int SERVICE_SERVICE_OFF_GETDYNSTRESSWAVE = 21072;//
        ...
        //*          时间值                 FIELD_SERVICE_OFF_TIME
        //*/
        public static int SERVICE_SERVICE_OFF_GETSEPCCHANNCUSTOMSTREND = 21073;//
                                                                               //
                                                                               ///** 获取离线巡检数据：
        //*          公司ID        FIELD_SYSTEM_COMPANY
        //*          分厂名        FIELD_SYSTEM_FACTORY
        ...
        //*          转速         FIELD_SERVICE_OFF_REV
        //*/
        public static int SERVICE_SERVICE_OFF_GET_OFFLINE_DATA = 21074;//
        ...
        //*/
        //
        public static int SERVICE_SERVICE_OFF_GETALARMDATA = 21075;//
                                                                   //
                                                                   //
                                                                   ///**监测站级历史报警ID列表
        //*输入参数值：公司ID           FIELD_SYSTEM_COMPANY
        ...
        //
        //*/
        public static int SERVICE_SERVICE_OFF_GETALARMIDS = 21076;//
                                                                  ///***************************系统级功能*******************************/
        //
        ...
        //*          额定转速  FIELD_SERVICE_REV
        //*/
        public static int SERVICE_SYSTEM_GETPLANTSUDCHANN = 25000;//
        ...
        //*/
        public static int SERVICE_SYSTEM_GETPLANTOFSUBCORP = 25001;//
        ...
        //*/
        public static int SERVICE_SYSTEM_GETALLCHANN = 25002;//
        ...
        //*             测点所属列表      FIELD_SERVICE_CHANN1_LIST
        //*/
        public static int SERVICE_SYSTEM_GETSPECTYPECHANN = 25003;//
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GETCOMPANYTOFUSER = 25004;//
                                                                   //
        ...
        //*/
        public static int SERVICE_SYSTEM_GETALLAXISCHANN = 25005;//
                                                                 //
        ...
        //*/
        public static int SERVICE_SYSTEM_GETPLANTANALYSISLINES = 25006;//
                                                                       ///**得到指定公司、分厂、设备的设备详细信息
        //*输入参数：   公司名    FIELD_SYSTEM_COMPANY
        //*             分厂名    FIELD_SYSTEM_FACTORY
        //*             机组号    FIELD_SYSTEM_PLANT
        ...
        //*/
        public static int SERVICE_SYSTEM_GETPLANTINFO = 25007;//
                                                              //
        ...
        //*/
        public static int SERVICE_SYSTEM_GETALLFACTORY = 25008;//
                                                               ///**得到指定所有公司信息
        //*返回值的字段码：
        //*                公司名    FIELD_SYSTEM_COMPANY
        ...
        //*                集团名    FIELD_SYSTEM_GROUP
        //*/
        public static int SERVICE_SYSTEM_GETALLCOMPANY = 25009;//
                                                               //
        ...
        //*          数据源     FIELD_SYSTEM_DATASOURCE
        //*/
        public static int SERVICE_SYSTEM_GETPLANTIPOFSUBCORP = 25010;//
                                                                     //
                                                                     ///**通过用户名和密码,修改密码
        //*输入参数：用户名   FIELD_SYSTEM_USEID
        //*          密码     FIELD_SYSTEM_PASSWORD
        ...
        //*/
        public static int SERVICE_SYSTEM_MODIFYPWD = 25011;//
                                                           ///**通过测点类型和传感器类型得到特征值描述
        //*输入参数：
        //*             设备类型    FIELD_SYSTEM_TYPE
        //*             测点类型    FIELD_SYSTEM_CHANN_TYPE
        ...
        //*/
        public static int SERVICE_SYSTEM_GETCHARTYPEDESC = 25012;//
                                                                 ///**通过用户名得到客户端页面的更新时间
        //*输入参数：用户名   FIELD_SYSTEM_USEID
        //*返回值的字段码：
        //*          刷新时间 FIELD_SYSTEM_REFRESHTIME
        //*/
        public static int SERVICE_SYSTEM_GET_REFRESHTIME = 25013;//
        ...
        //*/
        public static int SERVICE_SYSTEM_GETALARMTHRESHOLD = 25014;//
        ...
        //*          刷新时间 FIELD_SYSTEM_REFRESHTIME
        //*/
        public static int SERVICE_SYSTEM_LOGIN_CLIENT = 1000;//
        public static int SERVICE_SYSTEM_LOGIN = 25015;//
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_MODIFY_USERLEVEL = 25016;//
        ...
        //*            状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_ADD_NEWUSER = 25017;//
        ...
        //*            状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_SETCHECKALARMFLAG = 25018;//
                                                                   ///**得到指定机组位号的图结构类型信息
        //*输入参数：
        //*             公司名    FIELD_SYSTEM_COMPANY
        //*             分厂名    FIELD_SYSTEM_FACTORY
        ...
        //*/
        public static int SERVICE_SYSTEM_GETGRAPHTYPE_BY_DEVICEID = 25019;//
                                                                          //
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_MOIDFY_MWINFO = 25020;//
        ...
        //*          中间件PORT  FIELD_SYSTEM_MW_PORT
        //*/
        public static int SERVICE_SYSTEM_GET_MWINFO = 25021;//
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_MODIFY_SENDINFO = 25022;//
        ...
        //*          发送报警数据间隔    FIELD_SYSTEM_ALARM_SENDC_INTERVAL
        //*/
        public static int SERVICE_SYSTEM_GET_SENDINFO = 25023;//
                                                              ///**得到装置级中间件信息
        //*返回的字段码：
        //*         公司ID        FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRINFO = 25024;//
                                                                ///**得到装置级中间件服务器的设备详细信息
        //*返回的字段码：
        //*        设备信息  FIELD_SYSTEM_SETSVR_PLANTINFO
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRPLANTINFO = 25025;//
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRSPECPLANTCHANN = 25026;//
                                                                          ///**得到所有用户信息
        //*输入字段码：
        //*返回字段码：
        ...
        //*            刷新时间 FIELD_SYSTEM_REFRESHTIME
        //*/
        public static int SERVICE_SYSTEM_GET_ALLUSERINFO = 25027;//
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_MW_INFO = 25028;//
                                                             ///** 获取各个程序的路径和版本号
        //*输入参数字段码：无
        //*返回值的字段码：(n)
        ...
        //"3.5.0"
        //*/
        public static int SERVICE_SYSTEM_GET_MODULE_VERSION = 25029;//
                                                                    ///** 获取各个数据库状态
        //*输入参数字段码：无
        //*返回值的字段码：(n)
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_DB_STATUS = 25030;//
                                                               ///** 获取中间件运行状态
        //*输入参数字段码：无
        //*返回值的字段码：(1)
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SERVER_STATUS = 25031;//
                                                                   //
                                                                   ///** 获取数采硬件状态
        //*输入参数值：无
        //*返回值的字段码：(n)
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_DAQ_HW_STATUS = 25032;//
                                                                   ///** 获取数采软件状态
        //*输入参数值：无
        //*返回值的字段码：(1)
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_DAQ_SW_STATUS = 25033;//
                                                                   //
                                                                   ///** 获取基本的组态息
        //* 输入参数值：无
        //* 返回值的字段码：(1)
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_BASIC_CONFIG_INFO = 25034;//
                                                                       // /**
                                                                       //   根据设备得到用户关联信息。
                                                                       //   *输入参数字段码
                                                                       //   *          公司名          FIELD_SYSTEM_COMPANY
                                                                       ...
                                                                       //   *
                                                                       //   */
        public static int SERVICE_SYSTEM_GET_USER_OF_PLANT = 25041;
         ...
         *          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
         */
        public static int SERVICE_SYSTEM_GET_PLANT_OF_USER = 25040;
        // /** 用户管理接口
        //   *输入参数：
        ...
        //   *          状态描述        FIELD_SYSTEM_STATUS_DISCRIPTION
        //   */
        public static int SERVICE_SYSTEM_ACTION_USER_PLANT = 25042;//
                                                                   //
        ...
        //*          状态     FIELD_SYSTEM_STATUS
        //*/
        public static int SERVICE_SYSTEM_CONN_STATUS = 25100;//
                                                             //
                                                             ///**得到指定机组的所有测点信息。
        ...
        //*             状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_CHANNINFO = 25108;//
                                                               ///**得到指定分厂的所有机组信息。
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_PLANTINFO = 25109;//
                                                               ///**得到指定机组的指定测点名信息
        //*input param：机组名 FIELD_SYSTEM_PLANT
        //*             测点名 FIELD_SYSTEM_CHANN
        //*return field code：
        ...
        //*             状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_SPEC_CHANNINFO = 25110;//
                                                                    ///**得到指定分厂的所有机组信息。
        //*input param: 分厂名  FIELD_SYSTEM_SUBCORP
        //*             机组名   FIELD_SYSTEM_PLANT
        //*return field code：
        ...
        //*          状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_SPECPLANTINFO = 25111;//
                                                                   ///**得到监测中心的设备信息表
        //*输入参数：   公司名    FIELD_SYSTEM_COMPANY
        //*             分厂名     FIELD_SYSTEM_FACTORY
        //*             机组号     FIELD_SYSTEM_PLANT
        ...
        //*             单位       FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRMACHINEINFOTYPE = 25112;//
                                                                           ///**得到监测中心的信息描述表
        //* 输入字段码：
        //*返回的字段码：
        //*        信息类型      FIELD_SYSTEM_TYPE
        //*        对应描述      FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRINFOTYPEDETAIL = 25113;//
        ...
        //*        单位       FIELD_SERVICE_CHANN1_UNIT
        //*/
        public static int SERVICE_SYSTEM_GET_INFOTYPEDETAILBASETYPE = 25114;//
        ...
        //*/
        public static int SERVICE_SYSTEM_MODIFY_SPECCHANNALARMINFO = 25115;//
                                                                           ///**得到监测中心的自定义参数模板表
        //* 输入字段码：
        //*返回的字段码：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRTEMPLET = 25116;//
                                                                   ///**得到监测中心的自定义参数信息表
        //*输入参数值：
        //*返回参数值：
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRCUSTOMPARAM = 25117;//
                                                                       ///**得到监测中心的自定义参数报警参数模板表
        //*输入参数值：
        //*返回参数值：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRALARMTEMPLET = 25118;//
                                                                        ///**得到监测中心的自定义参数报警参数信息表
        //*输入参数值：
        //*返回参数值：
        //*         索引ID                 FIELD_SYSTEM_STATUS
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRALARMPARAM = 25119;//
        ...
        //*         报警组                 FIELD_SYSTEM_ALARM_GROUP
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRCHANNELALARMPARAM = 25120;//
        ...
        //*         特征值类型             FIELD_SYSTEM_CHAR_TYPE
        //*/
        public static int SERVICE_SYSTEM_GET_SPECSETSVRCUSTOMPARAM = 25121;//
        ...
        //*         报警组                 FIELD_SYSTEM_ALARM_GROUP
        //*/
        public static int SERVICE_SYSTEM_GET_SPECSETSVRALARMPARAM = 25122;//
                                                                          ///**得到监测中心配置的自定义轴承参数表
        //* 输入字段码：
        //*返回的字段码：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRCUSTOMBEARINGTBL = 25123;//
                                                                            ///**得到监测中心的齿轮箱参数表
        //*输入参数值：
        //*返回参数值：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*         备注                   FIELD_SYSTEM_STATUS_DISCRIPTION
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRGEARBOXTBL = 25124;//
                                                                      ///**得到监测中心的位置参数表
        //*输入参数值：
        //*返回参数值：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRLOCATIONTBL = 25125;//
                                                                       ///**得到监测中心的部位参数表
        //*输入参数值：
        //*返回参数值：
        //*         公司名                 FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SYSTEM_GET_SETSVRSECTIONTBL = 25126;//
                                                                      ///**得到中间件的版本号
        //*输入参数值：
        //*返回参数值：
        //*         版本号                 FIELD_SERVICE_FILE_VERSION
        ...
        //*/
        //
        public static int SERVICE_SYSTEM_GET_MILLDLEWARE_VERSION = 25127;//
                                                                         //
                                                                         ///***************************专家系统功能部分*******************************/
        //
        ...
        //*/
        public static int SERVICE_EXPERTSYS_GET_REGALARMFEATUREEXTRACT = 30001;//
        ...
        //*             对应的值   FIELD_SERVICE_EX_IDVALUE    //对应为int形
        //*/
        public static int SERVICE_EXPERTSYS_GET_SPECCHANNFEATUREEXTRACT = 30002;//
                                                                                //
                                                                                ///**得到指定振动测点、选定时间段时,专家诊断系统特征提取的知识
        //*输入参数：   公司名     FIELD_SYSTEM_COMPANY
        //*             分厂名     FIELD_SYSTEM_FACTORY
        ...
        //*             对应的值   FIELD_SERVICE_EX_IDVALUE    //对应为int形
        //*/
        public static int SERVICE_EXPERTSYS_GET_SPECCHANNFEATUREEXTRACT_RC = 30003;//
                                                                                   ///** 一次得到全部的设备信息
        ...
        //*/
        public static int SERVICE_SYSTEM_GETPLANTIPOFSUBCORP_EX = 25210;//
                                                                        //
                                                                        ///**返回动平衡类型
        //*  输入参数字段码：
        //*                公司名         FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_GET_BALANCE_DATA = 24063;//
                                                                       //
                                                                       ///**接收动平衡类型
        //*输入参数字段码：
        //*                公司名         FIELD_SYSTEM_COMPANY
        ...
        //*/
        public static int SERVICE_SERVICE_OFF_SET_BALANCE_DATA = 24062;//
                                                                       //
                                                                       //
                                                                       ///**报警信息确认
        //*输入参数字段码：
        ...
        //*                同步状态      FIELD_SYSTEM_STATUS               1,保存成功 0，保存失败
        //*/
        public static int SERVICE_SERVICE_OFF_SET_ALARM_CONFIRM_DATA = 24066;//
        ...
        public static int SERVICE_SYSTEM_SET_USERINFO = 24071;

        /**发送机组运行状态数据到中间件模块。即各个测点数据的报警状态
         *输入参数字段码：
         *            版本             FIELD_SYSTEM_VERSION
         *            设备数           FIELD_SERVICE_PLANT_NUM
         if FIELD_SYSTEM_VERSION == VERSION_PLANT_STATUS_IN_BLOB：
         *        长度             FIELD_SERVICE_LEN
         *        状态             FIELD_SYSTEM_STATUS
         if FIELD_SYSTEM_VERSION == VERSION_PLANT_STATUS_IN_FIELDS:
         *        公司ID           FIELD_SYSTEM_COMPANY
         *        分厂名           FIELD_SYSTEM_FACTORY
         *        机组ID           FIELD_SERVICE_PLANTID
         ...
         *            状态描述 FIELD_SYSTEM_STATUS_DISCRIPTION
         */
        public static int SERVICE_SERVICE_ON_SET_PLANT_STATUS = 24041;
