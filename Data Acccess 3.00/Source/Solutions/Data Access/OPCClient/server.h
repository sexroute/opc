...
class CKServer : public CObject  
	...
	public:
		...
		static 		bool AdjustPrivileges(IUnknown * apData, COAUTHIDENTITY& arefIdentityInfo);
		static 		bool AdjustPrivileges(IUnknown * apData);
		static CString UserName() ;
		static void UserName(CString val);
		static CString Password() ;
		static void Password(CString val);
	public:
