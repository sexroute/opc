...
#ifndef _CBHOpcDaDeviceItem_H_
#define _CBHOpcDaDeviceItem_H_
...
//==============================================================================
// CLASS:   CBHOpcDaDeviceItem
// PURPOSE: A source server for data exchange data.

class CBHOpcDaDeviceItem : public IOpcXmlSerialize
{
    OPC_CLASS_NEW_DELETE()
...
public:
    ...
    // Constructor
    CBHOpcDaDeviceItem(const COpcString& cItemID) { Init(); m_cItemID = cItemID; this->RealSample(FALSE);}

    // Destructor 
    ~CBHOpcDaDeviceItem() { Clear(); }
	...
	// Update
	void Update(LONGLONG uTicks, UINT uInterval);

	// Update for BHDevice
	void UpdateBHDevice(LONGLONG uTicks, UINT uInterval,OpcXml::AnyType&  arefNewValue);
	...
	//whether in realSample mode
	BOOL RealSample() const;
	void RealSample(BOOL val);
...
private:
	...
	// AddItemAndLink
	bool AddItemAndLink(const COpcString& cItemPath);

	// RemoveItemAndLink
	void RemoveItemAndLink(const COpcString& cItemPath);
	...
	// UpdateBHDevice
	bool UpdateBHDevice( OpcXml::AnyType& cValue, 
	...
	BOOL				 m_bRealSample; //Real Sample from BH Device
...
//============================================================================
// TYPEDEF: CBHOpcDaDeviceItemMap
// PURPOSE: A table of device items indexed by item id.

typedef COpcMap<COpcString,CBHOpcDaDeviceItem*> CBHOpcDaDeviceItemMap;

#endif // _CBHOpcDaDeviceItem_H_
