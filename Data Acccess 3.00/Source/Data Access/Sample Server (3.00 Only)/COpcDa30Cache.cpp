...
static COpcDa30Cache*      g_pCache  = NULL;
...
bool Initialize()
{
    ...
    TRY
    {
		...
		g_pCache = new COpcDa30Cache(*g_pDevice);
...
// Load
bool COpcDa30Cache::Load(COpcXmlElement& cRoot)
{
    COpcLock cLock(*this);
