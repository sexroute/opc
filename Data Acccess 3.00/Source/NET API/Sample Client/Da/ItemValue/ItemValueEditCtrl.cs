...
namespace Opc.Da.SampleClient
{
	...
	public class ItemValueEditCtrl : System.Windows.Forms.UserControl, IEditObjectCtrl
	{
		...
		private Opc.SampleClient.EnumCtrl QualityBitsCTRL;
		private Opc.SampleClient.EnumCtrl LimitBitsCTRL;
		private System.Windows.Forms.Label LimitBitsLB;
		private System.Windows.Forms.Label VendorBitsLB;
		private Opc.SampleClient.ValueCtrl ValueCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.QualityBitsCTRL = new Opc.SampleClient.EnumCtrl();
			this.LimitBitsCTRL = new Opc.SampleClient.EnumCtrl();
			this.LimitBitsLB = new System.Windows.Forms.Label();
			this.VendorBitsLB = new System.Windows.Forms.Label();
			this.ValueCTRL = new Opc.SampleClient.ValueCtrl();
		...
		public void SetDefaults()
		{
			...
			QualityBitsCTRL.Value        = Opc.Da.qualityBits.bad;
			LimitBitsCTRL.Value          = Opc.Da.limitBits.none;
		...
		public object Get()
		{
			Opc.Da.ItemValue item = new Opc.Da.ItemValue(m_identifier);
			...
			// set quality fields.
			item.Quality = Opc.Da.Quality.Bad;

			if (QualitySpecifiedCB.Checked)
			{
				Quality quality = new Quality();

				quality.QualityBits = (Opc.Da.qualityBits)QualityBitsCTRL.Value;
				quality.LimitBits   = (Opc.Da.limitBits)LimitBitsCTRL.Value;
		...
		public void Set(object value)
		{
			...
			Opc.Da.ItemValue item = (Opc.Da.ItemValue)value;
