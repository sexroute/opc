...
{	
	...
	/// </summary>
	public delegate void BrowseFiltersChangedCallback(BrowseFilters filters);
	...
	public class BrowseFiltersDlg : System.Windows.Forms.Form
	{
		...
		private Opc.Da.SampleClient.PropertyFiltersCtrl PropertyFiltersCTRL;
		...
		private Opc.SampleClient.EnumCtrl BrowseFilterCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.PropertyFiltersCTRL = new Opc.Da.SampleClient.PropertyFiltersCtrl();
			...
			this.BrowseFilterCTRL = new Opc.SampleClient.EnumCtrl();
			...
			this.ApplyBTN.Location = new System.Drawing.Point(143, 7);
			...
			this.PropertyFiltersCTRL.PropertyIDs = new Opc.Da.PropertyID[0];
			...
			// ElementNameFilterTB
			// 
			this.ElementNameFilterTB.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			...
			// VendorFilterTB
			// 
			this.VendorFilterTB.Anchor = ((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right);
		...
		private void ApplyChanges()
		{
			...
			filters.BrowseFilter         = (browseFilter)BrowseFilterCTRL.Value;
