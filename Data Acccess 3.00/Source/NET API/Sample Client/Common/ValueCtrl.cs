...
namespace Opc.SampleClient
{
	...
	public class ValueCtrl : System.Windows.Forms.UserControl
	{
		...
		private Opc.SampleClient.DataTypeCtrl DataTypeCTRL;
		...
		private void InitializeComponent()
		{
			...
			this.DataTypeCTRL = new Opc.SampleClient.DataTypeCtrl();
		...
		public void Set(object value, bool readOnly)
		{
			...
			if (m_type.IsArray)
			{
				ValueTB.Text         = (string)Opc.Convert.ChangeType(m_value, typeof(string));
				ValueTB.Visible      = true;
				EditPN.Visible       = true;
				DateTimeCTRL.Visible = false;
				return;
