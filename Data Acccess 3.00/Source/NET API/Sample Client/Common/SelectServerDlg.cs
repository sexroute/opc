...
namespace Opc.SampleClient
{
	...
	public class SelectServerDlg : System.Windows.Forms.Form
	{
		...
		private Opc.SampleClient.BrowseTreeCtrl ServersCTRL;
		...
		public SelectServerDlg()
		{
			...
			SpecificationCB.Items.Add(Specification.COM_AE_10);		
			SpecificationCB.Items.Add(Specification.COM_BATCH_10);	
			SpecificationCB.Items.Add(Specification.COM_BATCH_20);	
			SpecificationCB.Items.Add(Specification.COM_DA_10);
			SpecificationCB.Items.Add(Specification.COM_DA_20);	
			SpecificationCB.Items.Add(Specification.COM_DA_30);	
			SpecificationCB.Items.Add(Specification.COM_DX_10);
			SpecificationCB.Items.Add(Specification.COM_HDA_10);	
		...
		private void InitializeComponent()
		{
			...
			this.ServersCTRL = new Opc.SampleClient.BrowseTreeCtrl();
		...
		/// </summary>
		public Opc.Server ShowDialog(Specification specification)
		{
			...
			Opc.Server server = ServersCTRL.SelectedServer;
			ServersCTRL.Clear();
			return server;
		}
		...
		/// </summary>
		private void OnServerPicked(Opc.Server server)
		{
