...
namespace Opc.SampleClient
{
	...
	/// </summary>
	public delegate void ConnectServer_EventHandler(Opc.Server server);
	...
	public class SelectServerCtrl : System.Windows.Forms.UserControl
	{
		...
		/// </summary>
		private Opc.Specification m_specification = Specification.COM_DA_30;

		/// <summary>
		/// Initializes the control with a set of known urls.
		/// </summary>
		public void Initialize(URL[] knownUrls, int selectedIndex, Opc.Specification specification)
		{
		...
		public void Connect()
		{
			...
			Opc.Server server = Factory.GetServerForURL(url);
		...
		private void ServerUrlCB_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			{
				Opc.Server server = new SelectServerDlg().ShowDialog(m_specification);
