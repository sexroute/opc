...
const LPTSTR  OPC_CATEGORY_DESCRIPTION_DA20_T	=	_T("OPC Data Access Servers Version 2.0");
const LPTSTR  OPC_CATEGORY_DESCRIPTION_DA30_T	=	_T("OPC Data Access Servers Version 3.0");
